...
def zed2_process(shared):
    ...
    calib_data = np.load(r'/home/robocon/Desktop/Dominic/MultiMatrixzed21080.npz')  # Replace with your filename
            ...
            try:
                ...
                print(int(shared['axis'][0]), int(shared['axis'][1]), int(shared['axis'][2]), int(shared['axis'][3]), int(shared['l2']),int(shared['r2']),
                        int(shared['r1']),int(shared['l1']), int(shared['cross']), int(shared['square']), int(shared['circle']),
                            int(shared['triangle']), int(shared['pwm']), int(shared['bldc_rpm']),int(shared['pass_bldc']),int(shared['dist_pass']))
                ...
                try:
                    ...
                    if data == b'\x01':
                        ...
                        response = struct.pack(
                            ...
                            int(shared['r1']),int(shared['l1']), int(shared['cross']),int(shared['square']) ,int(shared['circle']),
                            int(shared['triangle']), int(shared['pwm']), int(shared['bldc_rpm']), int(shared['pass_bldc'])
                        )
