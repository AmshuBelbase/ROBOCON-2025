...
calib_data_path = r"/home/robocon/Desktop/Dominic"
...
np.savez(
    f"{calib_data_path}/MultiMatrixLenevo",
    camMatrix=mtx,
    distCoef=dist,
    rVector=rvecs,
    tVector=tvecs,
...
data = np.load(f"{calib_data_path}/MultiMatrixLenevo.npz")
