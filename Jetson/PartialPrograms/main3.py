        ...
        def process_hoop(self):
            ...
            for res in self.results:
                for box in res.boxes:
                    ...
                    frame_height, frame_width = self.frame.shape[:2]
                    self.offset = self.x_center - frame_width // 2+centre_shift
    ...
    while True:
        try:
            ...
            while True:
                ...
                frame= cv2.line(frame, (frame_width//2-centre_shift - err_off,0), (frame_width//2-centre_shift - err_off,frame_height), (255,0,255), 2)
                frame= cv2.line(frame, (frame_width//2-centre_shift + err_off,0), (frame_width//2-centre_shift + err_off,frame_height), (255,255,0), 2)
