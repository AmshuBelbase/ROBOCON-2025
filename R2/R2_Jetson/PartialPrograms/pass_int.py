...
turn_mode = "None" # "Passing", "Shooting"
        ...
        try:
            ...
            while True:
                ...
                if shared["turn_mode"] == "Shooting":
                    # Run Shooting Code Here.

                    # Constants for hoop distance
                    CONFIDENCE_THRESHOLD = 0.25
                    FRAME_SKIP = 5
                    BASKET_WIDTH_CM = 47.2
                    CONST = 1067.6 #Calibrated constant
                    ...
                    for res in results:
                        for box in res.boxes:
                            ...
                            cv2.putText(frame, f"Offset: {round(error_offset_april,2)}", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3)
                            cv2.putText(frame, f"Dist: {distance:.2f}", (500, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3)
                            cv2.putText(frame, f"Offset: {round(error_offset,2)}", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3)
                    if not det:
                ...
                elif shared["turn_mode"] == "Passing":
                    # Run Passing Code Here.
                ...
                elif shared["turn_mode"] == "None":
                    # stop bldc and turning effect
                    pass
...
def ps4_process(shared):
    ...
    global bldc_rpm , joystick, pass_bldc, turn_mode
    ...
    while True:
        ...
        if joystick:
            ...
            try:
                ...
                shared["touch_button"] = touch_button

                shared["bldc_rpm"] = bldc_rpm
                shared["pass_bldc"] = pass_bldc
                ...
                if shared['distance']==0 or bldc_rpm>3000:
                    bldc_rpm = 0
                if shared['dist_pass']==0 or pass_bldc>3000:
                    pass_bldc = 0
                ...
                print(int(shared['axis'][0]), int(shared['axis'][1]), int(shared['axis'][2]), int(shared['axis'][3]), int(shared['l2']),int(shared['r2']),
                        int(shared['r1']),int(shared['l1']), int(shared['cross']), int(shared['square']), int(shared['circle']),
                            int(shared['triangle']), dpad_up, dpad_down, dpad_right, dpad_left, shared["turn_mode"])
